...
export const MapComponent: React.FC<MapComponentProps> = ({
    ...
    (polygon: google.maps.Polygon) => {
      try {
        ...
        if (coordinates.length >= 3) {
          ...
          const boundary = [coordinates] as unknown as [[[number, number]]];
          ...
          const updateBoundaryFromPolygon = () => {
            ...
            const updatedCoordinates: [number, number][] = updatedPaths.map(
            ...
            const updatedBoundary = [updatedCoordinates] as unknown as [
              [[number, number]]
            ];
  ...
  const hasValidBoundary =
    selectedBoundary && selectedBoundary[0] && selectedBoundary[0].length >= 3;
    ...
    <div style={{ position: "relative" }}>
      ...
      <div style={{ marginTop: 8, fontSize: "12px", color: "#666" }}>
        ...
        <ul style={{ margin: "4px 0", paddingLeft: "16px" }}>
          ...
          {enableDrawing && (
            <li>Use polygon tool (top center) to draw boundaries</li>
          )}
